...
ROUTER_DEMAND_WINDOW_SECONDS = int(
    os.getenv("ROUTER_DEMAND_WINDOW_SECONDS", "10")
)
ROUTER_MEDIUM_DEMAND_RPS = float(os.getenv("ROUTER_MEDIUM_DEMAND_RPS", "0.75"))
ROUTER_HIGH_DEMAND_RPS = float(os.getenv("ROUTER_HIGH_DEMAND_RPS", "2.0"))
ROUTER_SWITCH_COOLDOWN_SECONDS = float(
    os.getenv("ROUTER_SWITCH_COOLDOWN_SECONDS", "2.0")
)
